Welcome to MinSoC. In order to put the system up and running you still have to follow two steps. 

1. Follow the INSTALL.pdf document found in this same directory. It will guide you to install the OpenCores modules which are part of the MinSoC system but not delivered with it. Furthermore, it will guide you to install the tools required to compile OpenRISC firmware and to connect to the system (upload and debug firmware). 

2. Follow the HOWTO.pdf document found in this same directory. This document guides you to compile MinSoC firmwares, to simulate the system running its firmware, and to synthesize the system to create a FPGA bitfile to configure your FPGA. Finally, it also guides you in running your first firmware on your FPGA. 
